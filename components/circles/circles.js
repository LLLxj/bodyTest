...
Component({
  ...
  methods: {
    ...
    drawCircleBg: function (id) {
      ...
      this.setData({
        size: 2 * 50   // 更新属性和数据的方法与更新页面数据的方法类似
      });
      // 使用 wx.createContext 获取绘图上下文 ctx  绘制背景圆环
      var ctx = wx.createCanvasContext(id)
      ctx.setLineWidth(50 / 2);
    ...
    drawCircle: function (id) {
      ...
      // 设置渐变
      var gradient = context.createLinearGradient(100, 50, 0);
      ...
      // step 从0到2为一周
      var step = 0.4;
      context.arc(50, 50, 45, -Math.PI / 2, step * Math.PI - Math.PI / 2, false);
